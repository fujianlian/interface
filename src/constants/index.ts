...
export const PUSDT = new Token(ChainId.PLATON_TESTNET, '0x6A04AcbD67f6878A1Cc3DdDf7ACc45afA97057b1', 18, 'USDT', 'Tether USD')
...
const WETH_ONLY: ChainTokenList = {
  ...
  [ChainId.PLATON_TESTNET]: [WETH[ChainId.PLATON_TESTNET]]
}
