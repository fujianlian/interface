...
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, ETHER } from '@plat-dex/uniswap-sdk'
...
export function isPlatOnChains(chainId?: ChainId): boolean {
  return chainId === ChainId.PLATON_TESTNET
}